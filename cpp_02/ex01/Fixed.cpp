// *this is the object currently being created.
// Writing "*this = other" calls the copy assignment operator (operator=)
// to copy the contents of 'other' into the current object.
// Since operator= calls getRawBits(), that function is executed too
